...
import { Box, Typography, Paper, Button, CircularProgress, Alert, Menu, MenuItem } from '@mui/material'
        ...
        <Box sx={{ height: 'calc(100vh - 100px)', display: 'flex', flexDirection: 'column' }}>
            <Box sx={{ mb: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Box sx={{ display: 'flex', gap: 1 }}>
                    ...
                    >
                        <MenuItem onClick={() => handleSmartLabelClose('<<SmartLabel>>')}>Generic Smart Label</MenuItem>
